...
def dice_battle():
    ...
    if die_1 > die_2:
        return "Player 1 rolled a " + str(die_1) + " and Player 2 rolled a " + str(die_2) + ". Player 1 wins!"
    elif die_1 < die_2:
        return "Player 1 rolled a " + str(die_1) + " and Player 2 rolled a " + str(die_2) + ". Player 2 wins!"
    else:
        return "Player 1 rolled a " + str(die_1) + " and Player 2 rolled a " + str(die_2) + ". It's a tie!"
